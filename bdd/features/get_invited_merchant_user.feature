Feature: Get invited merchant user info by token
  ...
  Scenario: Successfully get admin merchant user info via invitation
    ...
    """
      {
        ...
        "should_accept_tc": true
      }
    """
    And the response status code should be 200

  Scenario: Successfully get non-admin merchant user info via invitation
