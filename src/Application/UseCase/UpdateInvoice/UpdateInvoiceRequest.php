 ...
 *     properties={
 *          @OA\Property(property="external_code", ref="#/components/schemas/TinyText", example="M-0002126", description="Invoice external code which the invoice will be identified by."),
