...
/**
 * @OA\Get(
 *     path="/docs/v2/billie-pad-openapi.yaml",
 ...
 * )
 */
class PublicApiV2SpecController extends AbstractApiSpecController
{
    private const API_GROUP_WHITELIST = ['publicV2'];
    ...
    {
        return $this->createResponse($request, 'publicV2');
    }
}
