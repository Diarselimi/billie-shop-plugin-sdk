...
{
    const SELECT_FIELDS = 'id, merchant_id, debtor_financing_limit, min_order_amount, score_thresholds_configuration_id, created_at, updated_at';
    ...
    public function insert(MerchantSettingsEntity $merchantSettingsEntity): void
    {
        $id = $this->doInsert('
            ...
            (merchant_id, debtor_financing_limit, min_order_amount, score_thresholds_configuration_id, created_at, updated_at)
            VALUES
            (:merchant_id, :debtor_financing_limit, :min_order_amount, :score_thresholds_configuration_id, :created_at, :updated_at)
        ', [
