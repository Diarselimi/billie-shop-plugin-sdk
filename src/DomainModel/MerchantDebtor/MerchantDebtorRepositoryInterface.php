...
interface MerchantDebtorRepositoryInterface
{
    ...
    public function getOneByExternalIdMerchantIdAndExludedOrderStates(string $externalMerchantId, string $merchantId, array $excludedOrderStates = []): ?MerchantDebtorEntity;
