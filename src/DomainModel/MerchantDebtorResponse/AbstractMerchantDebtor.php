 ...
 *      @OA\Property(property="financing_limit", type="number", format="float", description="Full limit assigned to this merchant debtor."),
 *      @OA\Property(property="financing_power", type="number", format="float", description="Current available limit for this merchant debtor."),
