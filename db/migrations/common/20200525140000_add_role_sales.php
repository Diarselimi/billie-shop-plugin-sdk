...
class AddRoleSales extends TransactionalMigration
{
    protected function migrate()
    {
        ...
        foreach ($merchants as $merchant) {
            ...
            $rows[] = [
                ...
                'name' => MerchantUserDefaultRoles::ROLE_SALES['name'],
                'permissions' => json_encode(MerchantUserDefaultRoles::ROLE_SALES['permissions']),
                'created_at' => $now,
                'updated_at' => $now,
            ];
        }
