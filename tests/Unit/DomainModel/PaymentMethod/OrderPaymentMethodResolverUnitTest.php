...
class OrderPaymentMethodResolverUnitTest extends UnitTestCase
{
    ...
    public function shouldGetDirectDebitInfoFromFirstInvoiceForOrdersV1(): void
    {
        ...
        $bankTransferMethod = $paymentMethods->first();
        $this->assertEquals(PaymentMethod::TYPE_BANK_TRANSFER, $bankTransferMethod->getType());
        $this->assertEquals('DE27500105171416939916', $bankTransferMethod->getBankAccount()->getIban()->toString());
        $this->assertEquals('BICXXXX', $bankTransferMethod->getBankAccount()->getBic());
        $this->assertNull($bankTransferMethod->getSepaMandate());
        $this->assertNull($bankTransferMethod->getSepaMandateExecutionDate());
        ...
        $this->assertNotNull($directDebitPaymentMethod->getSepaMandateExecutionDate());
    }
